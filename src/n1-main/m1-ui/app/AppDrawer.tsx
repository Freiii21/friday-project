...
export const AppDrawer = ({toggle,switchDrawer}:PropsType) => {
  ...
  return(
      <Drawer open={toggle}  onClose={()=>switchDrawer(false)}>
          ...
          <MenuItem><NavLink to={PATH.REGISTRATION} className={({isActive}) => (isActive ? `${s.activeClass} ${s.links}`
          ...
          <MenuItem><NavLink to={PATH.PAGE_NOT_FOUND} className={({isActive}) => (isActive ? `${s.activeClass} ${s.links}`
              : s.links)}>Page not found</NavLink></MenuItem>
          <MenuItem><NavLink to={PATH.PASSWORD_RECOVERY} className={({isActive}) => (isActive ? `${s.activeClass} ${s.links}`
          ...
          <MenuItem><NavLink to={PATH.TEST_PAGE} className={({isActive}) => (isActive ? `${s.activeClass} ${s.links}`
