...
import {getPacksTC} from '../../../m2-bll/reducers/packsReducer';
...
export const ButtonForTablePacks = ({nameCell}: PropsType) => {
    ...
    let onClick = () => {
        // if (arrow) {
        //     dispatch(getPacksTC({sortPacks: '0' + nameCell, pageCount: numberPages}));
        //     setArrow(!arrow);
        // } else {
        //     dispatch(getPacksTC({sortPacks: '1' + nameCell, pageCount: numberPages}));
        //     setArrow(!arrow);
        // }
